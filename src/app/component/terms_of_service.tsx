    ...
    <div className="bg-gray-100 min-h-screen pb-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <p className="mb-4">
          ...
          privacy policy linked on the footer on adzylabs.com
        </p>
        ...
        <p>
          Our contact information is posted below: Adzy Labs LLC
          Support@adzylabs.com 317 George St, 3rd FL New Brunswick, NJ, 08901
        </p>
      </div>
    </div>
  );
